            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="WG-<?=date("Y");?><?=random_string('numeric', 5);?>">
                </div>
                <div class="form-group">
